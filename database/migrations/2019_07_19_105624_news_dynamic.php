...
class NewsDynamic extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('news_subjects')->insert([
            ['slug' => 'business', 'name' => 'Business', 'locale' => 'en', 'category' => '4'],
            ['slug' => 'consumerTech', 'name' => 'Technology', 'locale' => 'en', 'category' => '6'],
            ['slug' => 'entertainment', 'name' => 'Entertainment', 'locale' => 'en', 'category' => '5'],
            ['slug' => 'environment', 'name' => 'Environment', 'locale' => 'en', 'category' => '6'],
            ['slug' => 'FrBusiness', 'name' => 'Business', 'locale' => 'fr', 'category' => '7'],
            ['slug' => 'FrEnvironment', 'name' => 'Environment', 'locale' => 'fr', 'category' => '8'],
            ['slug' => 'FrHealth', 'name' => 'Santé', 'locale' => 'fr', 'category' => '8'],
            ['slug' => 'FrMedia', 'name' => 'Médias', 'locale' => 'fr', 'category' => '9'],
            ['slug' => 'FrNational', 'name' => 'National', 'locale' => 'fr', 'category' => '7'],
            ['slug' => 'FrSports', 'name' => 'Sports', 'locale' => 'fr', 'category' => '9'],
            ['slug' => 'FrWorld', 'name' => 'International', 'locale' => 'fr', 'category' => '7'],
            ['slug' => 'health', 'name' => 'Health', 'locale' => 'en', 'category' => '6'],
            ['slug' => 'hockey', 'name' => 'Hockey', 'locale' => 'en', 'category' => '3'],
            ['slug' => 'national', 'name' => 'National', 'locale' => 'en', 'category' => '1'],
            ['slug' => 'oddities', 'name' => 'Oddities', 'locale' => 'en', 'category' => '5'],
            ['slug' => 'sports', 'name' => 'Sports', 'locale' => 'en', 'category' => '3'],
            ['slug' => 'world', 'name' => 'World', 'locale' => 'en', 'category' => '2'],
        ]);
    }
